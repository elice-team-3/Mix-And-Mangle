...
import { useApiEventsEventIdDelete } from '@/services/이벤트/이벤트'

const EventDeleteDialog = ({ event }: { event: EventResponse }) => {
  const mutation = useApiEventsEventIdDelete()
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <p className="mb-30 text-center text-20 font-semibold">
          해당 행사를 삭제하시겠습니까?
        </p>
        <DialogFooter>
