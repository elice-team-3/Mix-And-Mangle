...
export const apiEventsEventIdPutBody = zod.object({
  ...
  "status": zod.enum(['대기중', '진행중', '종료됨', '취소됨']).or(zod.null()).optional(),
...
export const aIApiEventsEventIdAiGrouppingPostResponse = zod.record(zod.string(), zod.object({
...
export const apiEventsEventIdSetGroupPostResponse = zod.array(apiEventsEventIdSetGroupPostResponseItem)
