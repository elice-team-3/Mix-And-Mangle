...
export const getApiSessionsGetQueryOptions = <TData = Awaited<ReturnType<typeof apiSessionsGet>>, TError = ErrorType<unknown>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof apiSessionsGet>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
export function useApiSessionsGet<TData = Awaited<ReturnType<typeof apiSessionsGet>>, TError = ErrorType<unknown>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof apiSessionsGet>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useApiSessionsGet<TData = Awaited<ReturnType<typeof apiSessionsGet>>, TError = ErrorType<unknown>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof apiSessionsGet>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
